...
WHERE u.id = 1
  ...
  AND FIND_IN_SET('approve', prr.action_scope) > 0
  AND pal.process_instance_id = 'p2_flowable_sample_proc_001'
  AND pal.task_id = 'p2_flowable_sample_task_001'
